...
#content-button { position:absolute; left:-10px; top:-20px; margin:10px 30px 0 10px; 
width:180px; }
...
<body>
	...
	<?php include("includes/info-col-cards.php"); ?>
		<div id="content"><!-- Start of the thank you page content. -->
			...
			<p class="cntr">When you have completed your registration you will be able to login 
			...
			<option value="Standard 5 Year &pound;125">Standard 5 Year &pound;125 &pound; 
			125.00 GBP
			</option>
			...
			name="submit" alt="PayPalThe safer, easier way to pay online."> 
