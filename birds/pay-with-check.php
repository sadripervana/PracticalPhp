	...
	<div id='container'>
		...
		<div id='content'><!--Start of page content-->
			<div id="midcol">
				...
				<h3>Thank you for registering online. Now please fill out this form.&nbsp; Asterisks 
				indicate essential fields.<br>When you have filled out the form please print two 
				copies by clicking the "Print This Form" button. <br>Sign one copy and keep one for 
				reference. Sign a check payable to &quot;The Devon Bird Reserves&quot;. <br>Mail the 
				signed form and check to: <br>The Treasurer, The Devon Bird Reserves, 99 The Street, 
				...
				<br>
				<div id="button">#4
					<input type="button" value="Click to automatically print the form in black and 
