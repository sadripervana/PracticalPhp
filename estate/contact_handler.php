...
$formurl = "http://localhost/PHPProjects/PracticalPhp/estate/contact.php" ;
$errorurl = "http://localhost/PHPProjects/PracticalPhp/estate/error.html" ;
$thankyouurl = "http://localhost/PHPProjects/PracticalPhp/estate/thankyou.html" ;
$emailerrurl = "http://localhost/PHPProjects/PracticalPhp/estate/emailerr.html" ;
$errorcommentturl ="http://localhost/PHPProjects/PracticalPhp/estate/commenterror.html" ;
$uself = 0;
