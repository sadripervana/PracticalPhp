...
src="../images/header.png" width="128">
</header>
...
// Make the query
$q = "SELECT ref_num, loctn, thumb, price, mini_descr, type, b_rooms, full_spec, #4
...
// Message
echo '<p class="error">The record could not be retrieved. We apologize for any 
inconvenience.</p>';
...
?>
<p>No houses displayed? Either we have nothing that matches your requirements at the 
