	...
	<div id="container">
		...
		<div id="content">
			...
			<div id="midcol">
				...
				<h3>To arrange a viewing please click the Contact Us button and quote the 
				reference number1003</h3>
				<p>&pound;400,000</p>
				<p>A large and superbly presented detached house located in a beautiful valley in
					South Devon. Four good size bedrooms, all en-suite. Three generous reception rooms, luxury 
					kitchen and main bathroom.<br>Double Garage with radio operated doors. Parking space for
					three cars in front of the house. Large landscaped rear garden (approximately one acre)
