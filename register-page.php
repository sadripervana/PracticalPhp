...
require ('mysqli_connect.php'); // Connect to thedb.
...
// Check for a password and match it againstthe confirmed password
...
// Make the query:
$q = "INSERT INTO users (user_id, fname, lname,
email, psword, registration_date, user_level)
VALUES (null, '$fn', '$ln', '$e', SHA1('$p'), NOW(), 0
)";
$result = @mysqli_query ($dbcon, $q); // Runthe query.
...
to a system error. We apologize
...
occurred:<br>';
foreach ($errors as $msg) { // Extract theerrors from the array and echo themecho " - $msg<br>\n";
}
...
<p><label class="label" for="fname">First Name:
</label>
...
$_POST['email']; ?>" > </p>
<p><label class="label" for="psword1">Password:
</label>
...
<p><label class="label" for="psword2">Confirm
Password:</label><input id="psword2" type="password" name="psword2"
size="12" maxlength="12"
