...
// Make the query
$q = "INSERT INTO members (member_id, uname, email, psword, reg_date, member_level ) 
VALUES (NULL, '$uname', '$e', SHA1('$p'), NOW(), $ml)";
...
<p class="cntr">Terms:Your registration and all your messages will be immediately 
cancelled<br>if you post unpleasant, obscene or defamatory messages to this forum.</p>
<h3 class="content">When you click the 'Register' button, you will see a confirmation 
page <br></h3>
